...
public class BuscasBinarias {
    ...
    public BuscasBinarias() {  //m�todo construtor principal
        ...
        String paisesA [] = { "Ucrânia", "Turquia", "Suiça", "México", "França", "Espanha", 
                              "Chile", "Brasil" , "Argentina" };
        String paisesB [] = { "Argentina", "Brasil", "Chile", "Dinamarca", "Espanha", "França", 
                              "Inglaterra", "Turquia", "Uruguai" };
        String paisesC [] = { "Canadá", "Áustria", "Chile", "Italia", "Portugal", "Grécia", 
    ...
    public int buscaSequencial(String paises[], String x) {
        //... completar a l�gica
        //...
        return -1;
    }
